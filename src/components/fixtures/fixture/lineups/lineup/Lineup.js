			...
			return (
				<div className="lineup">
					...
					<div>
						...
						{
							lineup.startXI.map(player => <p className="body-text lineup-player-name" id={player.player.id}>
																						<span className="body-text lineup-player-number">{player.player.number}</span>
																					{player.player.name}</p>
						)}
						<h3 className="lineup-title heading-text">substitutes</h3>
						{
							lineup.substitutes.map(player => <p className="body-text lineup-player-name" id={player.player.id}>
																								<span className="body-text lineup-player-number">{player.player.number}</span>
																							{player.player.name}</p>
						)}
					</div>
